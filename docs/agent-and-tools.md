...
6. Normalize the return value and hand its terminal outcome to the execution-group coordinator. A serial call commits its `ToolResultMessage` before emitting `tool_execution_end`; parallel groups use the ordering contract below.
