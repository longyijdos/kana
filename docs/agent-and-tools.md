...
| --- | --- | --- |
| `user` | `id`, required `provenance`, `content: string` | Direct, scheduled, recovery, context-summary, or compaction-policy input. |
