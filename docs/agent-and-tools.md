...
| `job_output` | `jobId`, optional `waitMs` (0–30000; default 0) | Consumes the next bounded, previously unseen output from the Agent cursor. It may wait for output or a terminal state without stopping the Job and reports dropped bytes explicitly. |
