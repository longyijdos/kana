...
| `agent.background_jobs.max_consecutive_completion_wakes` | Positive integer | `3` | Maximum consecutive idle Agent runs started only by Job completions. Human-authored input resets the counter. |
