...
- Resume reconstructs committed journal messages, the latest context checkpoint, and the latest todo state. Process-local inbox, wake, and Goal state is intentionally outside the session format; see [Conversation runtime](conversation-runtime.md).
